...
class MiClase:
    def __init__(self, publico, protegido, privado):
        self.publico = publico #acceso fuera y dentro de la clase
        self._protegido = protegido # Solo dentro de la misma clase o clase hija , pero si es afuera de la clase con get o  set 
        self.__privado = privado  #solo en la dentro clase
